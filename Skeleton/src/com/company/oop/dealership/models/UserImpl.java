...
public class UserImpl implements User {
    ...
    private static final String VEHICLE_MESSAGE = "%d. %s";
    ...
    public void addVehicle(Vehicle vehicle) {
        if (userRole.equals(UserRole.NORMAL) && vehicles.size() == NORMAL_ROLE_VEHICLE_LIMIT) {
    ...
    public String printVehicles() {
        ...
        if (vehicles.size() == 0) {
            ...
            for (Vehicle vehicle : vehicles) {
                builder.append(String.format(VEHICLE_MESSAGE, counter, vehicle.toString()))
